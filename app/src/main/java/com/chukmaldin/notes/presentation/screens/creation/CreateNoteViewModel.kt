package com.chukmaldin.notes.presentation.screens.creation

import android.net.Uri
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.chukmaldin.notes.domain.AddNoteUseCase
...
class CreateNoteViewModel @Inject constructor(
    ...
    private val _state =
        MutableStateFlow<CreateNoteState>(CreateNoteState.Creation())
